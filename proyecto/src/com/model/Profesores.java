...
@NamedQueries({
    ...
    @NamedQuery(name = "Profesores.findByDescripcion", query = "SELECT p FROM Profesores p WHERE p.descripcion = :descripcion")})
public class Profesores implements Serializable {
    ...
    public String toString() {
        return "com.model.Profesores[ cedula=" + cedula + " ]";
    }
